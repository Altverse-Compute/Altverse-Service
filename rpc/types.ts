...
export type AuthenticationRequest =
  ProtoGrpcType["connection"]["AuthenticationRequest"];
export type AuthenticationResponse =
  ProtoGrpcType["connection"]["AuthenticationResponse"];
...
export type JoinPlayerRequest =
  ProtoGrpcType["connection"]["JoinPlayerRequest"];
export type JoinPlayerResponse =
  ProtoGrpcType["connection"]["JoinPlayerResponse"];
